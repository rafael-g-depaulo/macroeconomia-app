...
import { useManagingEditor, strapi } from '@api'
import { footerGreen } from '@styles'
...
const Centered = styled.div`
  ...
  align-items: center;
`
const ContactItem = ({ icon, children }: { icon: any; children: any }) => (
  <Centered>
    {/* <span>|</span> */}
    {icon}
...
export const Footer = ({ ...props }) => {
  ...
  return (
    <MyFooter {...props}>
      ...
      {width && width <= widthBreakpoint ? (
        <>
          <SocialMedia />
          <DevRights>
            Developed by rafael.g.depaulo@gmail.com &amp; designed by
