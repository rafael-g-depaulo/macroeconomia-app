...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Author: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Autor'>
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private
    ...
    Title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'T\u00EDtulo'>
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private
  }
...
export interface ApiDmBulletinDmBulletin extends Struct.CollectionTypeSchema {
  collectionName: 'dm_bulletins'
  info: {
    displayName: 'DM Bulletin'
    pluralName: 'dm-bulletins'
    singularName: 'dm-bulletin'
  }
  options: {
    draftAndPublish: true
  }
...
export interface ApiManagingEditorManagingEditor
  extends Struct.SingleTypeSchema {
  collectionName: 'managing_editors'
  info: {
    description: ''
    displayName: 'Managing Editor'
    pluralName: 'managing-editors'
    singularName: 'managing-editor'
  }
  options: {
    draftAndPublish: true
  }
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::dm-bulletin.dm-bulletin': ApiDmBulletinDmBulletin
      'api::event.event': ApiEventEvent
      'api::managing-editor.managing-editor': ApiManagingEditorManagingEditor
